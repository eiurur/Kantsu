    ...
    if (movie.links.length === 0) {
      ...
      html = `
        <div style="color:white;">
          <a style="margin:.5rem 0;" class="btn btn-lg btn-info btn-block open-with-eh" data-links="${cleanLinks}">
      ...
      html = `
        <div style="color:white;">
          <a style="margin:.5rem 0;" class="btn btn-lg btn-success btn-block open-with-eh" data-links="${cleanLinks}">
